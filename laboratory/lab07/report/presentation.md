...
При $\alpha _1(t) >> \alpha _2(t)$ получается модель типа модели Мальтуса, решение которой имеет вид [рис.1]

![рис.1 График решения уравнения модели Мальтуса](image/01.png){ #fig:001 width=70% height=70% }

## Теоретический материал

В обратном случае $\alpha _1(t) << \alpha _2(t)$ получаем уравнение логистической кривой [рис.2]

![рис.2 График логистической кривой](image/02.png){ #fig:002 width=70% height=70% }
...
## График в первом случае [рис.3]

![рис.3 График для случая 1](image/03.png){ #fig:003 width=70% height=70% }

## График во втором случае [рис.4]

![рис.4 График для случая 2](image/04.png){ #fig:004 width=70% height=70% }

максимальная скорость распространения при $t=0.01$

## График в третьем случае [рис.5]

![рис.5 График для случая 3](image/05.png){ #fig:005 width=70% height=70% }
