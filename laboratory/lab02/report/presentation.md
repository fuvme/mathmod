...
author: |
	 Виноградова Варвара Станиславвна НФИбд-01-18\inst{1}

institute: |
	\inst{1}Российский Университет Дружбы Народов

date: МатМод--2021, 19 февраля, 2021, Москва, Россия
...
![Cлучай 1](image/pic01.png){ #fig:001 width=50% height=50% }
...
![Cлучай 2](image/pic02.png){ #fig:002 width=50% height=50% }
...
Смоделировала задачу о погоне. Провели анализ и вывод дифференциальных уравнений. Смоделировали ситуацию.
Заметила, что при погоне «по часовой стрелке» для достижения цели потребуется пройти значительно меньшее расстояние.
