...
силы $\ddot{x}+10.1\dot{x}+0.1x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+3\dot{x}+3.3x=0.2\sin{3.5t}$

На интервале $t \in [ 0;33 ]$, шаг 0.05, $x_0=0, y_0=-1.4$
...
$$\ddot{x}+3\dot{x}+3.3x=0.2\sin{3.5t}$$
...
В ходе выполнения лабораторной работы построела решения уравнения гармонического осциллятора и фазовые портреты гармонических колебаний без затухания, с затуханием и при действии внешней силы.
